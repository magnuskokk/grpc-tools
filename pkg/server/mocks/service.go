...
// Source: servicetool/services/heartbeat (interfaces: HeartbeatServiceServer)
...
import (
	context "context"
	heartbeat "grpc-tools/services/heartbeat"
	reflect "reflect"
...
func (m *MockHeartbeatServiceServer) Ping(arg0 context.Context, arg1 *heartbeat.PingRequest) (*heartbeat.PingReply, error) {
	m.ctrl.T.Helper()
...
func (m *MockHeartbeatServiceServer) Stream(arg0 *heartbeat.StreamRequest, arg1 heartbeat.HeartbeatService_StreamServer) error {
	m.ctrl.T.Helper()
